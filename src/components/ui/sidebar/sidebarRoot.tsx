...
export const SidebarRoot = ({ open, onOpenChange, children }: ComponenteInterativo) => {
  ...
  useEffect(() => {
    ...
    const clickOutsideEvent = (e : MouseEvent) => {
            if (sidebarRef.current && !sidebarRef.current.contains(e.target as Node)) console.log("ops")
    }
